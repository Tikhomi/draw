...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.button_tools) {
                if (buttonsCheck) {
                    buttonsCheck = false;
                ...
                } else if (view.getId() == R.id.button_palette) {
                album.setFigure("drawing");
                } else if (view.getId() == R.id.button_clear_screen) {
            ...
            }else if (view.getId() == R.id.button_line) {
